...
describe Commands::Place do
  ...
  describe "#valid_table_position?" do
    context "when valid arguments" do
      let(:place_command) { described_class.new(simulation:simulation,arguments:["3","3"])}
  ...
  describe "#valid_direction?" do
    context "when valid arguments" do
      let(:place_command) { described_class.new(simulation:simulation,arguments:["3","3","NORTH"])}
  ...
  describe "#valid?" do
    context "when valid arguments" do
      let(:place_command) { described_class.new(simulation:simulation,arguments:["0","0","NORTH"])}
  ...
  describe "#execute" do
    ...
    context "when not valid arguments" do
      let(:place_command) { described_class.new(simulation:simulation,arguments:["3","3","ERROR"])}
      it "expect wil be placed in 3,3,NORTH" do
        place_command.execute
